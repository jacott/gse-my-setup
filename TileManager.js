...
import {getSettings, wsWindows, moveResize, moveResizeRect, rectIntersect, rectEnclosed, copyRect} from './Utils.js';
...
const initTile = () => {
  ...
  const iw = Array.from(wsWindows(undefined, mon)).sort(timeDescCompare);
